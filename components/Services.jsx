...
const Services = () => {
  return (
    ...
    transition={{duration: 0.5, delay: 0.7}}
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a frontend developer from Bhagalpur, Bihar with 0-2 years of experience in multiple companies like Microsoft, Tesla and Apple.</motion.p>
